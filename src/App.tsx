            ...
            <div className="mb-8 sm:mb-12 w-full max-w-5xl mx-auto px-4">
              <div className={`relative w-full h-0 pb-[56.25%] rounded-2xl overflow-hidden shadow-2xl border transition-colors duration-300 ${
                ...
                <iframe
                  ...
                  src="https://www.youtube.com/watch?v=RGproKPJ_Dg?playsinline=1&enablejsapi=1&cc_load_policy=1"
        ...
        <div className="max-w-6xl mx-auto w-full">
          <div className="text-center mb-16 animate-on-scroll">
            ...
            <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto px-4">
              Comprehensive AI Strategic solutions designed to streamline your operations and accelerate growth. Improve ALL your business processes with AI: Social Media, Legal, Project Management, and More...
            </p>
          </div>
