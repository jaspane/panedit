  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
      ...
      <section className="py-16 sm:py-20 px-4 sm:px-6 relative z-10">
        <div className="max-w-6xl mx-auto w-full">
          <div className="w-full mx-auto rounded-2xl h-[40rem] sm:h-[50rem] overflow-hidden border border-gray-700">
            <Vortex
              backgroundColor="rgba(0,0,0,0.9)"
              rangeY={800}
              particleCount={500}
              baseHue={220}
              className="flex items-center flex-col justify-center px-4 sm:px-10 py-8 w-full h-full"
            >
              <h2 className="text-white text-3xl sm:text-4xl md:text-6xl font-bold text-center mb-6 animate-on-scroll">
                Experience the Future of
                <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent block mt-2">
                  AI Automation
                </span>
              </h2>
              <p className="text-white text-base sm:text-lg md:text-2xl max-w-3xl mt-6 text-center leading-relaxed animate-on-scroll">
                Watch as our AI agents transform your business operations in real-time. 
                From lead qualification to customer support, experience the power of intelligent automation.
              </p>
              <div className="flex flex-col sm:flex-row items-center gap-4 mt-8 animate-on-scroll">
                <button
                  onClick={() => setIsModalOpen(true)}
                  className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 transition duration-300 rounded-lg text-white font-semibold shadow-[0px_2px_0px_0px_#FFFFFF40_inset] hover:shadow-xl hover:shadow-blue-500/25 transform hover:scale-105"
                >
                  Start Your AI Journey
                </button>
                <a
                  href="#features"
                  className="px-6 sm:px-8 py-3 sm:py-4 text-white border border-gray-600 hover:border-blue-400 hover:text-blue-400 transition duration-300 rounded-lg font-semibold"
                >
                  Explore Features
                </a>
              </div>
              ...
              {/* Stats in Vortex */}
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 mt-12 w-full max-w-4xl animate-on-scroll">
                <div className="text-center p-4 bg-black/20 backdrop-blur-sm rounded-xl border border-gray-700/50">
                  <div className="text-2xl sm:text-3xl font-bold text-blue-400 mb-2">500+</div>
                  <div className="text-sm sm:text-base text-gray-300">Businesses Automated</div>
                </div>
                <div className="text-center p-4 bg-black/20 backdrop-blur-sm rounded-xl border border-gray-700/50">
                  <div className="text-2xl sm:text-3xl font-bold text-purple-400 mb-2">10M+</div>
                  <div className="text-sm sm:text-base text-gray-300">Leads Generated</div>
                </div>
                <div className="text-center p-4 bg-black/20 backdrop-blur-sm rounded-xl border border-gray-700/50">
      ...
      <footer className="py-8 sm:py-12 px-4 sm:px-6 border-t border-gray-800 relative z-10">
        <div className="max-w-6xl mx-auto w-full">
          ...
          <div className="border-t border-gray-800 mt-8 sm:mt-12 pt-6 sm:pt-8 text-center text-sm text-gray-400">
            <p>&copy; 2025 Panèdit. All rights reserved.</p>
          </div>
        </div>
      </footer>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg focus:outline-none focus:border-blue-400 transition-colors text-sm sm:text-base"
                  required
                />
              </div>
              <div>
              ...
              <div>
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={4}
                  className="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg focus:outline-none focus:border-blue-400 transition-colors resize-none text-sm sm:text-base"
                ></textarea>
              </div>
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-500 to-purple-500 py-3 rounded-lg text-sm sm:text-base font-semibold hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300"
              >
                Schedule My Call
              </button>
            </form>
